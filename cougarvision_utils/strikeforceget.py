...
username = "<insert strikeforce username here>"
password = "<insert strikeforce password here>"
...
encode = 'json'
response = requests.post(url=call, data=body, headers={"Content-Type": "application/json"})
